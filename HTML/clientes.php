<?php
    ...
    // O arquivo de lógica já lida com a conexão e busca os clientes.
...
<body>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <table border="1" width="100%" id="tabelaClientes" class="table table-striped">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nome</th>
                ...
                <tbody>
                    <?php
                        ...
                        while ($cliente = $clientes_stmt->fetch()) {
                            ...
                            echo "    <td>
                                        <a href='dashboardCliente.php?id=" . htmlspecialchars($cliente['ID_Cliente']) . "' class='btn btn-sm btn-primary' title='Editar Cliente'>
                                            <i class='bi bi-pencil-fill'></i> Editar
                                        </a>
                                        <a href='../PHP/logica_cliente.php?acao=excluir&id=" . htmlspecialchars($cliente['ID_Cliente']) . "' 
                                           onclick=\"return confirm('Tem certeza que deseja excluir o cliente " . htmlspecialchars($cliente['Nome']) . "?');\" 
                                           class='btn btn-sm btn-danger' title='Excluir Cliente'>
